...
#and
select * from student_detail where saddr= 'chennai' and sfees= '1000.3';
# or
select * from student_detail where saddr = 'chennai' or sfees = '1000.3';
# or
select * from student_detail where saddr = 'chennai' or sfees = '2000.3';
# not
select * from student_detail where squalification!='BE';
# in
select * from student_detail where saddr in ('mumbai', 'chennai');
# in 
select * from student_detail where squalification in ('MSC', 'BE');
# starts with
...
select * from student_detail where sname like 'B%A';
# missing letters
select * from student_detail where saddr like 'che__ai';
select * from student_detail where squalification like 'B_';